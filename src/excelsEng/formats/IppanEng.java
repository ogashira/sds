...
public class IppanEng extends ABSEngFormat {
	...
	public IppanEng(StructInputForm inputForm) {
		insertEngFormat = new InsertEngFormat(inputForm, "ippanEng"); //ippanEng : sdsType
