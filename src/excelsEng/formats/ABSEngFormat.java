...
abstract class ABSEngFormat implements IFSdsFormatEng {
	...
	protected InsertEngFormat insertEngFormat;

	@Override
	public void insertHeader() {
		insertEngFormat.insertHeader();
	}
	...
	public void insertPictogram(List<String> listPict) {
		insertEngFormat.insertPict(listPict);

	}

	@Override
	public void insertHazardInfo(List<String> listHazardInfo) {
		insertEngFormat.insertHazardInfo(listHazardInfo);
