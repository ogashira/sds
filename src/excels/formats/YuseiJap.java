...
public class YuseiJap extends ABSJapFormat {
	//public class YuseiJap extends ABSJapFormat {
	...
	//Section8
	//管理濃度
	private final int[] KANRI_NOUDO = { 241, 7, 0 };
	//ACGIH
	private final int[] ACGIH = { 243, 7, 0 };
	//ACGIH 要素~より類推
	private final int[] ACGIH_YOUSO = { 243, 9, 79 };
	//日本産業衛生学会
	private final int[] NISSANEI = { 244, 7, 0 };
	//日本産業衛生学会 要素　～より類推
	private final int[] NISSANEI_YOUSO = { 244, 9, 79 };

	//Section9
	//物理的状態
	private final int[] CONDITION = { 259, 9, 0 };
	//色
	private final int[] COLOR = { 260, 9, 0 };
	//沸点または初留点
	private final int[] BOIL_POINT = { 263, 9, 0 };
	//爆発限界上限
	private final int[] UPPER_LIMIT = { 266, 9, 0 };
	//爆発限界下限
	private final int[] LOWER_LIMIT = { 267, 9, 0 };
	//引火点
	private final int[] FLASH_POINT = { 268, 9, 0 };
	//自然発火点
	private final int[] IGNITION_POINT = { 269, 9, 0 };
	//蒸気圧
	private final int[] VAPOR_PRESSURE = { 276, 9, 0 };
	//密度/相対密度
	private final int[] SG = { 277, 9, 0 };

	//Section11
	//急性毒性経口
	final int[] s11急毒経口 = { 297, 10, 77 }; //この70は仮(適当)
	//急性毒性経皮
	final int[] s11急毒経皮 = { 298, 10, 77 };
	//急性毒性吸入：気体
	final int[] s11急毒気体 = { 299, 10, 77 };
	//急性毒性吸入：蒸気
	final int[] s11急毒蒸気 = { 300, 10, 77 };
	//急性毒性吸入：粉塵、ミスト
	final int[] s11急毒粉塵 = { 301, 10, 77 };
	//皮膚刺激/腐食性
	final int[] s11皮膚刺激 = { 302, 10, 77 };
	//眼に対する重篤な損傷性/眼刺激性
	final int[] s11眼刺激性 = { 303, 10, 77 };
	//呼吸器感さ性 固体/液体
	final int[] s11呼吸器感作固液体 = { 304, 10, 77 };
	//呼吸器感さ性 気体
	final int[] s11呼吸器感作気体 = { 305, 10, 77 };
	//皮膚感さ性
	final int[] s11皮膚感作性 = { 306, 10, 77 };
	//生殖細胞変異原性
	final int[] s11変異原性 = { 307, 10, 77 };
	//発がん性
	final int[] s11発がん性 = { 308, 10, 77 };
	//生殖毒性
	final int[] s11生殖毒性 = { 309, 10, 77 };
	//生殖毒性・授乳影響
	final int[] s11生殖毒性授乳 = { 310, 10, 77 };
	//特定標的臓器毒性(単回暴露) 区分1
	final int[] s11単回ばく露1 = { 311, 10, 77 };
	//特定標的臓器毒性(単回暴露) 区分2
	final int[] s11単回ばく露2 = { 312, 10, 77 };
	//特定標的臓器毒性(単回暴露) 区分3
	final int[] s11単回ばく露3 = { 313, 10, 77 };
	//特定標的臓器毒性(反復暴露) 区分1
	final int[] s11反復ばく露1 = { 314, 10, 77 };
	//特定標的臓器毒性(反復暴露) 区分2
	final int[] s11反復ばく露2 = { 315, 10, 77 };
	//誤えん有害性
	final int[] s11誤えん有害性 = { 316, 10, 77 };

	//Section12
	//水生環境有害性 短期(急性)
	final int[] s12水生環境急性 = { 322, 10, 77 };
	//水生環境有害性 長期(慢性)
	final int[] s12水生環境慢性 = { 323, 10, 77 };
	//残留性・分解性
	final int[] s12残留性分解性 = { 324, 10, 77 };
	//生態蓄積性
	final int[] s12生態蓄積性 = { 325, 10, 77 };
	//土壌中の移動性
	final int[] s12土壌中の移動性 = { 326, 10, 77 };
	//オゾン層への有害性
	final int[] s12オゾン層有害性 = { 327, 10, 77 };

	//Section14
	//国連番号
	private final int[] UN_NO = { 346, 9, 0 };
	//品名（国連輸送名）
	private final int[] UN_NAME = { 347, 9, 0 };
	//国連分類
	private final int[] UN_CLASS = { 348, 9, 0 };
	//容器等級
	private final int[] UN_YOUKI = { 349, 9, 0 };
	//海洋汚染物質
	private final int[] marinePollu = { 350, 9, 0 };
	...
	public YuseiJap(StructInputForm inputForm) {

		insertJapFormat = new InsertJapFormat(inputForm, "yuseiJap");
