...
abstract class ABSJapFormat implements IFSdsFormat {
	...
	protected InsertJapFormat insertJapFormat;

	@Override
	public void insertHeader() {
		insertJapFormat.insertHeader();
	}
	...
	public void insertPictogram(List<String> listPict) {
		insertJapFormat.insertPict(listPict);

	}

	@Override
	public void insertHazardInfo(List<String> listHazardInfo) {
		insertJapFormat.insertHazardInfo(listHazardInfo);
