...
public class MetalJap extends ABSJapFormat {
	//public class MetalJap extends ABSJapFormat{
	...
	//管理濃度
	private final int[] KANRI_NOUDO = { 251, 7, 0 };
	//ACGIH
	private final int[] ACGIH = { 253, 7, 0 };
	//ACGIH 要素~より類推
	private final int[] ACGIH_YOUSO = { 253, 9, 79 };
	//日本産業衛生学会
	private final int[] NISSANEI = { 254, 7, 0 };
	//日本産業衛生学会 要素　～より類推
	private final int[] NISSANEI_YOUSO = { 254, 9, 79 };

	//Section9
	//物理的状態
	private final int[] CONDITION = { 269, 9, 0 };
	//色
	private final int[] COLOR = { 270, 9, 0 };
	//沸点または初留点
	private final int[] BOIL_POINT = { 273, 9, 0 };
	//爆発限界上限
	private final int[] UPPER_LIMIT = { 276, 9, 0 };
	//爆発限界下限
	private final int[] LOWER_LIMIT = { 277, 9, 0 };
	//引火点
	private final int[] FLASH_POINT = { 278, 9, 0 };
	//自然発火点
	private final int[] IGNITION_POINT = { 279, 9, 0 };
	//蒸気圧
	...
	//Section11
	//急性毒性経口
	final int[] s11急毒経口 = { 307, 10, 77 }; //この70は仮(適当)
	//急性毒性経皮
	final int[] s11急毒経皮 = { 308, 10, 77 };
	//急性毒性吸入：気体
	final int[] s11急毒気体 = { 309, 10, 77 };
	//急性毒性吸入：蒸気
	final int[] s11急毒蒸気 = { 310, 10, 77 };
	//急性毒性吸入：粉塵、ミスト
	final int[] s11急毒粉塵 = { 311, 10, 77 };
	//皮膚刺激/腐食性
	final int[] s11皮膚刺激 = { 312, 10, 77 };
	//眼に対する重篤な損傷性/眼刺激性
	final int[] s11眼刺激性 = { 313, 10, 77 };
	//呼吸器感さ性 固体/液体
	final int[] s11呼吸器感作固液体 = { 314, 10, 77 };
	//呼吸器感さ性 気体
	final int[] s11呼吸器感作気体 = { 315, 10, 77 };
	//皮膚感さ性
	final int[] s11皮膚感作性 = { 316, 10, 77 };
	//生殖細胞変異原性
	final int[] s11変異原性 = { 317, 10, 77 };
	//発がん性
	final int[] s11発がん性 = { 318, 10, 77 };
	//生殖毒性
	final int[] s11生殖毒性 = { 319, 10, 77 };
	//生殖毒性・授乳影響
	final int[] s11生殖毒性授乳 = { 320, 10, 77 };
	//特定標的臓器毒性(単回暴露) 区分1
	final int[] s11単回ばく露1 = { 321, 10, 77 };
	//特定標的臓器毒性(単回暴露) 区分2
	final int[] s11単回ばく露2 = { 322, 10, 77 };
	//特定標的臓器毒性(単回暴露) 区分3
	final int[] s11単回ばく露3 = { 323, 10, 77 };
	//特定標的臓器毒性(反復暴露) 区分1
	final int[] s11反復ばく露1 = { 324, 10, 77 };
	//特定標的臓器毒性(反復暴露) 区分2
	final int[] s11反復ばく露2 = { 325, 10, 77 };
	//誤えん有害性
	final int[] s11誤えん有害性 = { 326, 10, 77 };

	//Section12
	//水生環境有害性 短期(急性)
	final int[] s12水生環境急性 = { 332, 10, 77 };
	//水生環境有害性 長期(慢性)
	final int[] s12水生環境慢性 = { 333, 10, 77 };
	//残留性・分解性
	...
	//オゾン層への有害性
	final int[] s12オゾン層有害性 = { 337, 10, 77 };
	...
	//Section15
	//がん原生物質の挿入行
	private final int[] GAN_GENSEI = { 379, 10, 77 };
	//特化則の挿入行
	private final int[] TOKKASOKU1 = { 381, 10, 77 };
	private final int[] TOKKASOKU2 = { 383, 10, 77 };
	private final int[] TOKKASOKU3 = { 385, 10, 77 };
	//有機則の挿入行
	private final int[] YUUKISOKU = { 387, 10, 77 };
	//名称等を表示すべき有害物の行
	private final int[] LABEL_DISPLAY = { 389, 10, 77 };
	//名称等を通知すべき有害物
	private final int[] SDS_NOTIFICATION = { 391, 10, 77 };
	//第一種指定化学物質prtrの行
	private final int[] PRTR1 = { 394, 10, 77 };
	//第二種指定化学物質prtrの行
	private final int[] PRTR2 = { 396, 10, 77 };
	//特定第一種特定化学物質prtrの行
	private final int[] PRTR_TOKU1 = { 398, 10, 77 };
	//化審法優先評価化学物質の行
	private final int[] KASINHOU_YUUSEN = { 401, 10, 77 };
	//消防法
	private final int[] SYOUBOUHOU = { 403, 9, 0 };
	//船舶安全法
	private final int[] SHIP_SAFTY_ACT = { 405, 9, 0 };
	//航空法
	private final int[] AVIATION_ACT = { 407, 9, 0 };

	//成分表の最初と最後の行、列の最大バイト数 MSｺﾞｼｯｸでﾌｫﾝﾄｻｲｽﾞ10の場合
	private Map<String, Integer> tableComponentSize;

	public MetalJap(StructInputForm inputForm) {

		insertJapFormat = new InsertJapFormat(inputForm, "metalJap");
