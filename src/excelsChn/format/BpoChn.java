...
public class BpoChn extends ABSChnFormat {
	//public class BpoChn extends ABSChnFormat{
	...
	//Section8
	//管理濃度
	private final int[] KANRI_NOUDO = { 261, 7, 0 };
	//ACGIH
	private final int[] ACGIH = { 263, 7, 0 };
	//ACGIH 要素~より類推
	private final int[] ACGIH_YOUSO = { 263, 9, 79 };
	//日本産業衛生学会
	private final int[] NISSANEI = { 264, 7, 0 };
	//日本産業衛生学会 要素　～より類推
	private final int[] NISSANEI_YOUSO = { 264, 9, 79 };
	...
	//爆発限界上限
	private final int[] UPPER_LIMIT = { 286, 9, 0 };
	//爆発限界下限
	private final int[] LOWER_LIMIT = { 287, 9, 0 };
	//引火点
	private final int[] FLASH_POINT = { 288, 9, 0 };
	//自然発火点
	private final int[] IGNITION_POINT = { 289, 9, 0 };
	//蒸気圧
	private final int[] VAPOR_PRESSURE = { 296, 9, 0 };
	//密度/相対密度
	private final int[] SG = { 297, 9, 0 };

	//Section11
	//急性毒性経口
	final int[] s11急毒経口 = { 315, 10, 77 }; //この70は仮(適当)
	//急性毒性経皮
	final int[] s11急毒経皮 = { 316, 10, 77 };
	//急性毒性吸入：気体
	final int[] s11急毒気体 = { 317, 10, 77 };
	//急性毒性吸入：蒸気
	final int[] s11急毒蒸気 = { 318, 10, 77 };
	//急性毒性吸入：粉塵、ミスト
	final int[] s11急毒粉塵 = { 319, 10, 77 };
	//皮膚刺激/腐食性
	final int[] s11皮膚刺激 = { 320, 10, 77 };
	//眼に対する重篤な損傷性/眼刺激性
	final int[] s11眼刺激性 = { 321, 10, 77 };
	//呼吸器感さ性 固体/液体
	final int[] s11呼吸器感作固液体 = { 322, 10, 77 };
	//呼吸器感さ性 気体
	final int[] s11呼吸器感作気体 = { 323, 10, 77 };
	//皮膚感さ性
	final int[] s11皮膚感作性 = { 324, 10, 77 };
	//生殖細胞変異原性
	final int[] s11変異原性 = { 325, 10, 77 };
	//発がん性
	final int[] s11発がん性 = { 326, 10, 77 };
	//生殖毒性
	final int[] s11生殖毒性 = { 327, 10, 77 };
	//生殖毒性・授乳影響
	final int[] s11生殖毒性授乳 = { 328, 10, 77 };
	//特定標的臓器毒性(単回暴露) 区分1
	final int[] s11単回ばく露1 = { 329, 10, 77 };
	//特定標的臓器毒性(単回暴露) 区分2
	final int[] s11単回ばく露2 = { 330, 10, 77 };
	//特定標的臓器毒性(単回暴露) 区分3
	final int[] s11単回ばく露3 = { 331, 10, 77 };
	//特定標的臓器毒性(反復暴露) 区分1
	final int[] s11反復ばく露1 = { 332, 10, 77 };
	//特定標的臓器毒性(反復暴露) 区分2
	final int[] s11反復ばく露2 = { 333, 10, 77 };
	//誤えん有害性
	final int[] s11誤えん有害性 = { 334, 10, 77 };

	//Section12
	//水生環境有害性 短期(急性)
	final int[] s12水生環境急性 = { 340, 10, 77 };
	//水生環境有害性 長期(慢性)
	final int[] s12水生環境慢性 = { 341, 10, 77 };
	//残留性・分解性
	...
	//オゾン層への有害性
	final int[] s12オゾン層有害性 = { 342, 10, 77 };

	//Section14
	//国連番号
	private final int[] UN_NO = { 361, 9, 0 };
	//品名（国連輸送名）
	private final int[] UN_NAME = { 362, 9, 0 };
	//国連分類
	private final int[] UN_CLASS = { 363, 9, 0 };
	//容器等級
	private final int[] UN_YOUKI = { 364, 9, 0 };
	//海洋汚染物質
	private final int[] marinePollu = { 365, 9, 0 };

	//Section15
	//がん原生物質の挿入行
	private final int[] GAN_GENSEI = { 382, 10, 77 };
	//特化則の挿入行
	private final int[] TOKKASOKU1 = { 384, 10, 77 };
	private final int[] TOKKASOKU2 = { 386, 10, 77 };
	private final int[] TOKKASOKU3 = { 388, 10, 77 };
	//有機則の挿入行
	private final int[] YUUKISOKU = { 390, 10, 77 };
	//名称等を表示すべき有害物の行
	private final int[] LABEL_DISPLAY = { 392, 10, 77 };
	//名称等を通知すべき有害物
	private final int[] SDS_NOTIFICATION = { 394, 10, 77 };
	//第一種指定化学物質prtrの行
	private final int[] PRTR1 = { 397, 10, 77 };
	//第二種指定化学物質prtrの行
	private final int[] PRTR2 = { 399, 10, 77 };
	//特定第一種特定化学物質prtrの行
	private final int[] PRTR_TOKU1 = { 401, 10, 77 };
	//化審法優先評価化学物質の行
	private final int[] KASINHOU_YUUSEN = { 404, 10, 77 };
	//消防法
	...
	public BpoChn(StructInputForm inputForm) {

		insertChnFormat = new InsertChnFormat(inputForm, "bpoChn");
		//bpoChn:sdsType
		tableComponentSize = new HashMap<>();
		tableComponentSize.put("tableForNoticeSttRow", 136);
		tableComponentSize.put("tableForNoticeEndRow", 159);
